    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDiscard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Item_post.this, Navigation_Drawer.class);
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        SharedPreferences preferences = Item_post.this.getSharedPreferences("MY_APP", Context.MODE_PRIVATE);
                                        ...
                                        docRef.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                            ...
                                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                if (documentSnapshot.exists()) {
                                                    ...
                                                    Toast.makeText(Item_post.this, "Successfully Uploaded", Toast.LENGTH_SHORT).show();
                                                    Intent intent = new Intent(Item_post.this, Navigation_Drawer.class);
                                                    startActivity(intent);
                                                    finish();
