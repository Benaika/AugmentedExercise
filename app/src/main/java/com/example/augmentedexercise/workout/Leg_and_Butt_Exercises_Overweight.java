...
public class Leg_and_Butt_Exercises_Overweight extends AppCompatActivity {

    FirebaseFirestore fStore;
    DocumentReference documentReference;
    public int owLeg_Progress = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_and_butt_exercises_overweight);
    ...
    private void JumpingJack(){
        btnJumpingJack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                owLeg_Progress = owLeg_Progress + 10;
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()){
                                    ...
                                    progress.put("leg_progress", owLeg_Progress);

                                    // Set the document ID to be the same as the "id" field
                                    fStore.collection("leg_overweight").document(userID)
                                            .set(progress)
