...
public class Abs_Exercises_Normal extends AppCompatActivity {

    FirebaseFirestore fStore;
    DocumentReference documentReference;
    public int nAbs_Progress = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.augmentedexercise.R.layout.activity_abs_exercises_normal);
    ...
    private void JumpingJacks(){
        btnJumpingJack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nAbs_Progress = nAbs_Progress + 10;
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()){
                                    ...
                                    progress.put("abs_progress", nAbs_Progress);

                                    // Set the document ID to be the same as the "id" field
                                    fStore.collection("abs_normal").document(userID)
                                            .set(progress)
