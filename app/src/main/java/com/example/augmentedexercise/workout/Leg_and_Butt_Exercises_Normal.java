...
public class Leg_and_Butt_Exercises_Normal extends AppCompatActivity {

    FirebaseFirestore fStore;
    DocumentReference documentReference;
    public int nLeg_Progress = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.augmentedexercise.R.layout.activity_leg_and_butt_exercises_normal);
    ...
    private void JumpingJack(){
        btnJumpingJack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nLeg_Progress = nLeg_Progress + 10;
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()){
                                    ...
                                    progress.put("leg_progress", nLeg_Progress);

                                    // Set the document ID to be the same as the "id" field
                                    fStore.collection("leg_normal").document(userID)
                                            .set(progress)
