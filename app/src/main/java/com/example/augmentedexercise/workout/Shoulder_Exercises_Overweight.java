...
public class Shoulder_Exercises_Overweight extends AppCompatActivity {

    FirebaseFirestore fStore;
    DocumentReference documentReference;
    public int owShoulder_Progress = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoulder_exercises_overweight);
    ...
    private void JumpingJack(){
        btnJumpingJack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                owShoulder_Progress = owShoulder_Progress + 10;
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()){
                                    ...
                                    progress.put("shoulder_progress", owShoulder_Progress);

                                    // Set the document ID to be the same as the "id" field
                                    fStore.collection("shoulder_overweight").document(userID)
                                            .set(progress)
