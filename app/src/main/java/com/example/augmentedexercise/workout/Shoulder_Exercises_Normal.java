...
public class Shoulder_Exercises_Normal extends AppCompatActivity {

    FirebaseFirestore fStore;
    DocumentReference documentReference;
    public int nShoulder_Progress = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoulder_exercises_normal);
    ...
    private void JumpingJack(){
        btnJumpingJack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                nShoulder_Progress = nShoulder_Progress + 10;
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()){
                                    ...
                                    progress.put("shoulder_progress", nShoulder_Progress);

                                    // Set the document ID to be the same as the "id" field
                                    fStore.collection("shoulder_normal").document(userID)
                                            .set(progress)
