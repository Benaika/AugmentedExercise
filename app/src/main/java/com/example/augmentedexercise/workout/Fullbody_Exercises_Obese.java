...
public class Fullbody_Exercises_Obese extends AppCompatActivity {

    FirebaseFirestore fStore;
    DocumentReference documentReference;

    public int ofb_Progress = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fullbody_exercises_obese);
                        ...
                        documentReference.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()){
                                    ...
                                    progress.put("fullbody_progress", ofb_Progress);

                                    // Set the document ID to be the same as the "id" field
                                    fStore.collection("fullbody_obese").document(userID)
                                            .set(progress)
